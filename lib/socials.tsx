...
export const fullstackProjects: Project[] = [
  ...
  {
    title: 'reX',
    description: 'Community-first reward exchange platform.',
  ...
  {
    title: 'UniZ',
    description: 'University portal with smart outpass tracking.',
  ...
  {
    title: 'Spay',
    description: 'Simulated payment gateway with real banking logic.',
    liveUrl: 'https://srees-spay.vercel.app/',
    githubUrl: 'https://github.com/sreecharan-desu/Spay',
    tech: ['Next.js', 'Tailwind', 'Prisma', 'Postgres', 'NeonDB'],
  ...
  },
  {
    ...
    tech: ['TypeScript', 'TailwindCSS', 'Hono', 'Prisma', 'Postgres'],
  ...
  {
    title: 'StudySpace',
    description: 'Find your next study buddy. Offline-ready.',
    liveUrl: 'https://studyspace-exp.vercel.app/',
    githubUrl: 'https://github.com/sreecharan-desu/Studyspace',
    tech: ['TypeScript', 'Recoil', 'TailwindCSS'],
    image: '/project-images/studyspace.png',
    status: 'online',
  },
  {
    title: 'ChromaPost',
    description: 'Ad poster generator for social campaigns.',
  ...
  {
    title: 'CampusHub',
    description: 'All your campus events. One place.',
  ...
  {
    title: 'GradeLite',
    description: 'Simplified grade tracking & visualizations.',
  ...
  {
    title: 'Portfolio v1',
    description: 'The portfolio that started it all.',
